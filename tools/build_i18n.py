...
HOME = {
    "zh": dict(
        ...
        faq=[
            ...
            ("网站收录哪些游戏？", "目前收录 6 款经典街机与小游戏：贪吃蛇、2048、俄罗斯方块、扫雷、五子棋和记忆翻牌，并会持续上新。"),
        ],
        aboutH2="关于街机小游戏乐园",
...
PAGES = {
    "zh": dict(
        ...
        aboutH2c="我们提供什么",
        aboutPc="目前我们收录 6 款经典小游戏：贪吃蛇、2048、俄罗斯方块、扫雷、五子棋和记忆翻牌，全部为纯前端实现，加载快、无广告、适配手机与电脑。我们会持续上新，把更多优质的小游戏带到这里。",
        contactTitle="联系我们",
